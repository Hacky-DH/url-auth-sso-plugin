...
public class UrlSecurityRealm extends SecurityRealm implements UserDetailsService {
    ...
    public Filter createFilter(FilterConfig filterConfig) {
        ...
        return new Filter() {
            ...
            public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
                ...
                if (r.getQueryString() != null && targetUrl != null && !targetUrl.isEmpty()) {
                    //String cookies = r.getHeader("Cookie");
                    String cookies = URLDecoder.decode(r.getQueryString().split("=")[1], "utf-8");
                    ...
                    if (t.isAuthenticated()) {
                        ...
                        if (u != null) {
                            ...
                            if (!t.getUserDetails().getEmail().isEmpty())
                                u.addProperty(new Mailer.UserProperty(t.getUserDetails().getEmail()));
                        }
                    } else {
    ...
    public HttpResponse doLogin(StaplerRequest request, @Header("Referer") String referer, @Header("Cookie") String cookies) throws IOException {
        ...
        if (SecurityContextHolder.getContext().getAuthentication().equals(Jenkins.ANONYMOUS)) {
            ...
            if (savedReferer instanceof String && !((String) savedReferer).isEmpty())
                return new HttpRedirect((String) savedReferer);
